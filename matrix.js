...
$("#PlayMovieButton").click(function() {
    ...
    if(playing) {
      ...
      tclock = setInterval(function() {if(globalTimeIndex < MAX_TIME) 
                                        {$( "#TimeSlider" ).slider("value", globalTimeIndex);
                                          console.log(globalTimeIndex); globalTimeIndex += 1; 
                                          RedrawGraph(true);
                                        } else {
                                          globalTimeIndex = 0
                                          RedrawGraph(true)
